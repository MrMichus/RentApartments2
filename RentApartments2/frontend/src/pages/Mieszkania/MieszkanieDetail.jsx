  ...
  const nextImage = () => {
    if (mieszkanie?.zdjeciaUrls?.length > 0) {
      setCurrentImageIndex(
        (prev) => (prev + 1) % mieszkanie.zdjeciaUrls.length
      );
    }
  };
  ...
  if (!mieszkanie) {
    return (
      <div className="error-container">
        ...
        <Link to="/mieszkania" className="btn-back">
          Wróć do listy
        </Link>
      </div>
    );
          ...
          <div className="detail-main">
            ...
            <div className="detail-price">
              <span className="price-value">
                {mieszkanie.cenaMiesieczna?.toLocaleString()} zł
              </span>
            ...
            <div className="owner-card">
              ...
              <div className="owner-info">
                ...
                <div className="owner-details">
                  ...
                  <p className="owner-email">✉️ {mieszkanie.owner?.email}</p>
              ...
              {isAuthenticated() && mieszkanie.owner?.id !== user?.userId && (
                <button
